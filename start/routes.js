...
Route.get('/admin/products/categories/create', 'Admin/Products/CategoryController.create');
...
Route.get('/accounts/change-password', 'UserController.changePassword');
Route.get('/accounts/orders', 'UserController.orders');
